...
public class SysRoleController extends BaseController
{
    ...
    public AjaxResult edit(@Validated @RequestBody SysRole role)
    {
        ...
        return error("Failed to modify role '" + role.getRoleName() + "', please contact administrator");
    }

    /**
     * Modify and Save Data Permission
     */
    @PreAuthorize("@ss.hasPermi('system:role:edit')")
    @Log(title = "Role Management", businessType = BusinessType.UPDATE)
    ...
    /**
     * Get Department Tree List for Corresponding Role
     */
    @PreAuthorize("@ss.hasPermi('system:role:query')")
