...
public class SysDept extends BaseEntity
{
    ...
    @NotBlank(message = "Department namecannot be empty")
    @Size(min = 0, max = 30, message = "Department namelength cannot exceed30characters")
    ...
    @Size(min = 0, max = 11, message = "Contact Phonelength cannot exceed11characters")
