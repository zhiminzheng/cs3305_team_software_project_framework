...
public class SysDictData extends BaseEntity
{
    ...
    @Size(min = 0, max = 100, message = "Dictionary Labellength cannot exceed100characters")
    ...
    @NotBlank(message = "Dictionary Key Valuecannot be empty")
    @Size(min = 0, max = 100, message = "Dictionary Key Valuelength cannot exceed100characters")
    ...
    @Size(min = 0, max = 100, message = "Dictionary Typelength cannot exceed100characters")
    ...
    @Size(min = 0, max = 100, message = "Style attributes length cannot exceed 100 characters")
