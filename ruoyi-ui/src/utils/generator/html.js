...
function buildElUploadChild(conf) {
  ...
  if (conf.showTip) list.push(`<div slot="tip" class="el-upload__tip">Only upload ${conf.accept} files not exceeding ${conf.fileSize}${conf.sizeUnit}</div>`)
  return list.join('\n')
}
