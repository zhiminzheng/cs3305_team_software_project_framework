    ...
    return {
      ...
      registerRules: {
        username: [
          ...
          { min: 2, max: 20, message: 'User account length must be between 2 and 20 characters', trigger: 'blur' }
        ],
        password: [
      ...
      this.$refs.registerForm.validate(valid => {
        if (valid) {
          ...
          register(this.registerForm).then(res => {
            ...
            this.$alert("<font color='red'>Congratulations, your account " + username + " has been registered successfully!</font>", 'System Prompt', {
