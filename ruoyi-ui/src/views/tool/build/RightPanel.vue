<template>
  <div class="right-board">
      ...
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab==='field' && showField" size="small" label-width="90px">
          ...
          <el-form-item v-if="activeData.step !== undefined" label="Step">
            <el-input-number v-model="activeData.step" placeholder="Step Number" />
          </el-form-item>
          ...
          <template v-if="activeData.layout === 'colFormItem' && activeData.tag !== 'el-button'">
            ...
            >
              ...
              <el-form-item label="Pattern">
                <el-input v-model="item.pattern" placeholder="Please enter regex pattern" />
              </el-form-item>
        ...
        <el-form v-show="currentTab === 'form'" size="small" label-width="90px">
          ...
          <el-form-item label="Show Unselected Component Border">
    ...
    <treeNode-dialog :visible.sync="dialogVisible" title="AddOptions" @commit="addNode" />
...
export default {
  ...
  methods: {
    ...
    colorFormatChange(val) {
      ...
      this.activeData.renderKey = +new Date() // Update renderKey, re-render this component
    },
