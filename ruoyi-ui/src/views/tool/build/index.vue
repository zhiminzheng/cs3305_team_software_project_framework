    ...
    <div class="left-board">
      ...
      <el-scrollbar class="left-scrollbar">
        <div class="components-list">
          ...
          <div class="components-title">
            <svg-icon icon-class="component" />Selection Components
          </div>
          <draggable
            class="components-draggable"
        ...
        <el-row class="center-board-row" :gutter="formConf.gutter">
          ...
          >
            ...
            <div v-show="!drawingList.length" class="empty-info">
              Drag or click components from the left to design the form
            </div>
          </el-form>
        </el-row>
      </el-scrollbar>
...
export default {
  ...
  created() {
    // Prevent Firefox from opening a new tab when dragging
  ...
  mounted() {
    clipboard = new ClipboardJS('#copyNode', {
      text: trigger => {
        ...
        this.$notify({
          title: 'Success',
          message: 'Code has been copied to clipboard, you can paste it.',
          type: 'success'
        })
        return codeStr
      }
  ...
  methods: {
    ...
    cloneComponent(origin) {
      ...
      clone.renderKey = +new Date() // Changing renderKey can force component update
    ...
    empty() {
      this.$confirm('Are you sure to clear all components?', 'Prompt', { type: 'warning' }).then(
        () => {
          this.drawingList = []
